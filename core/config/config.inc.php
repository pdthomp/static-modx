...
$lastInstallTime = 1393970019;

$site_id = 'modx53164b639658d2.88477632';
$site_sessionname = 'SN53164a6998263';
$https_port = '443';
$uuid = 'ff5bb819-b00a-47d4-a678-2b1e71c56e73';
...
if (!defined('MODX_HTTP_HOST')) {
    if(defined('PHP_SAPI') && (PHP_SAPI == "cli" || PHP_SAPI == "embed")) {
        $http_host='modx.ackbar.amagllc.net';
